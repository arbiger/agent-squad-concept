...
2. Call `memory_read_people` (name: "george") — who you're helping
3. Call `memory_query` (query: "recent decisions and projects", limit: 5) — recent context from memory vault
